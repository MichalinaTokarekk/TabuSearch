...
def compare_algorithms(problem_sizes, iterations=5):
    ...
    for size in problem_sizes:
        ...
        for _ in range(iterations):
            ...
            time_vs_length["Simulated Annealing"].append((sa_time, tour_len))
            ...
            time_vs_length["Tabu Search"].append((ts_time, tour_len))
            ...
            time_vs_length["2-Opt"].append((opt_time, tour_len))
    ...
    # Plot results
    plot_results(problem_sizes, execution_times, memory_usages, tour_lengths, time_vs_length)

def plot_results(problem_sizes, execution_times, memory_usages, tour_lengths, time_vs_length):
    """
